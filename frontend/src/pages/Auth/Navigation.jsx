...
//       text-black bg-gradient-to-r from-rose-500 to-rose-100  bg-rose-400 w-[4%]  md:w-[4.5%] md:hover:w-[10%]  `}
...
//           <ul
//             className={`absolute left-0 mt-12 mr-4 rounded-lg  space-y-3 text-center py-2 bg-blue-400 text-gray-200 
